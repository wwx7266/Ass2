...
//Our JOGL program will pass in this value
//We use it to determine whether to use Blinn-Phong (halfvector)
//or Phong (reflection vector)
...
/* We are taking into consideration light0 and light1 and assuming 
   they are point lights and are always on */
void main (void) {	
